...
| Mantener tres vistas del fragmento: con contexto, texto crudo y ventanas de tamaño fijo | — | Ablación de representación sobre las 92 normas (dev+test) | [Cerrada] Las tres vistas (enriquecida, cruda, troceado clásico) no muestran diferencia detectable en recuperación; se conserva la enriquecida por su valor aguas abajo (cita/trazabilidad), no por ventaja de ranking |
