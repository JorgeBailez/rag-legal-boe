...
Estas propuestas son útiles como marco conceptual, pero no sustituyen necesariamente a una evaluación diseñada para el dominio concreto. En este TFG, la evaluación deberá combinar métricas reproducibles de recuperación, revisión cualitativa de respuestas, comprobación de citas y consultas fuera del corpus. Esta última categoría es especialmente importante porque el sistema debe indicar que no dispone de información suficiente cuando la pregunta no puede responderse con las evidencias disponibles.
...
\hline
``¿Qué pasa si la administración no me contesta?'' & Silencio administrativo, plazo máximo de resolución, efectos estimatorios o desestimatorios. \\
``¿Puedo reclamar si me cobran algo que no entiendo?'' & Derechos de consumidores y usuarios, información contractual, reclamación, cláusulas. \\
``¿Cuántos días tengo para recurrir una multa?'' & Plazo de interposición de recurso, procedimiento sancionador, notificación administrativa. \\
``¿Me pueden despedir estando de baja?'' & Extinción del contrato de trabajo, incapacidad temporal, causas de despido, protección frente a discriminación. \\
\hline
\end{tabular}
\end{table}
...
La comparación entre recuperación léxica, semántica e híbrida es una parte central del trabajo porque cada estrategia responde a una hipótesis distinta. La recuperación léxica puede funcionar bien cuando la consulta contiene términos jurídicos específicos. La recuperación semántica puede aportar valor cuando el usuario formula la pregunta con lenguaje cotidiano. La recuperación híbrida puede combinar ambas señales, aunque su superioridad debe demostrarse empíricamente. El \emph{reranking} se considera una alternativa relevante, pero su incorporación queda condicionada al coste y a la mejora observada.
