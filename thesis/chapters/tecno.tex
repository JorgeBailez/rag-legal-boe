...
Ruff \cite{ruff} & \emph{Linter} y formateador; puerta de calidad de estilo, incluidos los cuadernos. \\
...
Completan el conjunto varias utilidades de apoyo: \emph{loguru} para el registro de trazas, \emph{tqdm} para las barras de progreso, \emph{pandas} y \emph{matplotlib} para tabular y representar los resultados, e \emph{ipykernel} y \emph{nbconvert} para ejecutar los cuadernos, que consumen los informes generados sin reejecutar modelos.
