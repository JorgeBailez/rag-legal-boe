...
\begin{enumerate}
    ...
    \item[\textbf{OE-08}] \textbf{Favorecer la reproducibilidad, la extensibilidad y el uso responsable.} Documentar la arquitectura, la configuración y los procedimientos de ejecución; sostener el sistema íntegramente sobre modelos y herramientas de código abierto ejecutados en local, sin servicios externos de pago; facilitar la ampliación posterior del corpus; y analizar las limitaciones técnicas y jurídicas del prototipo.
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1.4cm}|p{11.8cm}|p{2.0cm}|}
        ...
        \hline
        RF-15 & El sistema deberá ofrecer un demostrador ejecutable (línea de comandos o cuaderno) que permita formular una consulta y obtener la respuesta fundamentada con sus citas. & Esencial \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1.5cm}|p{3.0cm}|p{10.7cm}|}
        ...
        \textbf{Código} & \textbf{Propiedad} & \textbf{Requisito no funcional} \\
        \hline
        RNF-06 & Ejecución local y abierta & El sistema deberá ejecutarse íntegramente con modelos y herramientas de código abierto en el servidor universitario, sin depender de servicios externos de pago. \\
        \hline
...
El ritmo de trabajo se ha ajustado al calendario de convocatorias de defensa de Trabajo Fin de Grado de la Escuela de Ingeniería de Fuenlabrada para el curso 2025--2026 \cite{urjcConvocatoriasTFGEIF2025_2026}. Asimismo, la elaboración de esta memoria sigue los requisitos de estructura, formato y contenido establecidos en el reglamento específico de Trabajo Fin de Grado de la Escuela \cite{urjcReglamentoTFGEIF2025}, que condiciona tanto la organización de los capítulos como la extensión máxima del documento.

En términos de calendario, el proyecto se desarrolló entre \textbf{noviembre de 2025} —con la definición del problema— y la entrega, en \textbf{julio de 2026}. La primera etapa, hasta la primavera de 2026, se dedicó a acotar el dominio y a un intento inicial sobre documentos legales en \emph{texto plano}; en torno a \textbf{mayo de 2026} el proyecto giró hacia la legislación consolidada del BOE. A partir de ahí, y de forma especialmente intensa en \textbf{junio y julio de 2026}, se encadenaron la ingesta y el procesamiento del corpus, la comparación de recuperadores, la generación y la evaluación, hasta el cierre documental.
...
Ninguno de estos ajustes desvió el objetivo general; al contrario, cada uno respondió a un obstáculo concreto y dejó el trabajo en mejor posición para alcanzarlo.