...
\begin{description}
  ...
  \item[OE-08 (reproducibilidad y uso responsable).] \textbf{Conseguido.} El sistema se sostiene íntegramente sobre software y modelos de código abierto ejecutados localmente, con artefactos versionados y trazables, y con un análisis explícito de sus límites técnicos, jurídicos y éticos.
\end{description}
