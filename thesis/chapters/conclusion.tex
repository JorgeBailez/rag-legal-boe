...
\begin{enumerate}
  ...
  \item \textbf{La ingeniería reproducible desde el principio ahorra dolor.} Contratos de datos, artefactos trazables (identificados por \emph{run\_id} y congelados en el paquete de evidencia) y una suite de pruebas sin red hicieron posible razonar sobre el sistema y confiar en cada tabla del capítulo de experimentos.
\end{enumerate}
