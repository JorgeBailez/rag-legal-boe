...
\hypersetup{
	...
	pdftitle={Diseño y evaluación con evidencia de un sistema RAG para la consulta ciudadana de legislación consolidada del BOE},
...
\large Diseño y evaluación de una arquitectura RAG\\
para un servicio de consulta ciudadana sobre legislación consolidada\\
del Boletín Oficial del Estado

\vspace{1.5cm}

\large
Autor/a : Jorge Bailez Martínez \\
\vspace{0.5cm}
Tutor/a : Dr. Felipe Ortega Soto
...
\begin{flushright}
%\textit{Dedicatoria opcional (una línea).}
\end{flushright}
